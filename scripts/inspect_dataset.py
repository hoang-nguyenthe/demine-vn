...
liệu bảng, rồi đề xuất cách ánh xạ sang cấu trúc mà DeMine-VN sử dụng.
...
FIELD_HINTS = {
    "lat": ["lat", "latitude", "y", "vi_do", "tgtlatdd", "target_lat"],
    "lon": ["lon", "lng", "longitude", "x", "kinh_do", "tgtlonddd", "target_lon"],
    "date": ["date", "msndate", "mission_date", "ngay", "thoi_gian", "year"],
    "mission_id": ["mission_id", "msnid", "sortie", "id_phi_vu", "valid_aircraft_root"],
    "weapon_count": ["numweaponsdelivered", "n_bombs", "so_luong", "quantity",
                     "weapon_count", "numwpnsdel"],
    "weapon_type": ["weapontype", "loai_vu_khi", "munition", "wpn_type"],
    "cleared": ["cleared", "da_ra_pha", "status", "clearance_status"],
    "items_found": ["items_found", "uxo_found", "so_vat_no", "items", "devices_found"],
    "area": ["area", "dien_tich", "area_m2", "hectares"],
    "accident_year": ["year", "nam", "accident_year", "incident_date"],
    "casualties": ["casualties", "victims", "so_nan_nhan", "killed", "injured"],
}
...
def main() -> int:
    ...
    print("\n7. BƯỚC TIẾP THEO")
    print("   Viết src/demine/data/loader_btc.py với hàm")
